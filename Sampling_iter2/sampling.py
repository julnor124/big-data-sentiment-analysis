...
"""
Run this script with this command, but change the dataset depending on which one you want to sample:
python -u Sampling_iter2/sampling.py \
  --input Sampling_iter2/postlaunch.labeled.csv \
  --output Sampling_iter2/postlaunch_sampled_400.csv \
  --sample-size 400
"""